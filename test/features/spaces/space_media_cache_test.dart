...
void main() {
  test('replacing a stable URL repeatedly changes its key and evicts only that asset', () async {
  ...
  test('failed disk eviction still refreshes the accepted update', () async {
    final cache = SpaceMediaCache(evict: (_) async => throw StateError('disk unavailable'));
