...
void main() {
  test(
    'relay preference defaults off and persists through settings round trip',
    () {
  ...
  test(
    'relay preference is serialized into the peer connection configuration',
    () {
      expect(
        voiceConnectOptions(
          true,
        ).rtcConfiguration.toMap()['iceTransportPolicy'],
        'relay',
      );
      expect(
        voiceConnectOptions(
