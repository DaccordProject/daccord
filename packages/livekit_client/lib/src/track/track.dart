...
abstract class Track extends DisposableChangeNotifier with EventsEmittable<TrackEvent> {
  ...
  Future<bool> stop() async {
    ...
    // bonfire #68: skip the native MediaStreamTrack.stop() free when leaking is
    // enabled (Linux libwebrtc heap-corrupts on native free during teardown).
    if (!kIsWeb && !kLiveKitSkipNativeRelease) {
