  ...
  Future<void> dispose({bool synchronized = true}) {
    Future<void> function() async {
      ...
      Future.delayed(const Duration(seconds: 5), () {
        ...
        // Only now, once mpv_terminate_destroy has synchronously joined the mpv
        // core thread, can no further wakeup fire — so the FFI trampoline is
        // safe to tear down. Closing it before this point is what aborted the
        // process on Linux whenever a video attachment was disposed.
        callable?.close();
      });
    }
