...
class Initializer {
  ...
  ///
  /// Returns the [WakeUpNativeCallable] when one was in use, so the caller can
  /// close it after `mpv_terminate_destroy`; `null` on the isolate path, which
  /// owns no FFI trampoline.
