...
| 70 | [Server Plugins](server_plugins.md) | Per-server plugin system with custom REST endpoints, WebSocket events, and sandboxed Lua client-side scripting; Activities as the first plugin type (voice-channel games, e.g., chess) |
