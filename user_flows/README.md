...
| 73 | [Plugin Test Coverage](plugin_test_coverage.md) | Plugin system test + security audit: 38 tests cover model/REST/cache/gateway; runtimes, download manager, canvas, context, UI (72%) untested; ZIP path traversal, stub signatures, trust-all bypass, BBCode injection, Lua CPU exhaustion |
