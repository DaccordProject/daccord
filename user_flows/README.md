...
| 76 | [Client MCP Server](client_mcp.md) | Local MCP server exposing client control to AI agents; per-account bearer token auth, tool groups (read/navigate/screenshot/message/moderate/voice), navigate-to-surface for all 121 UI audit entries, viewport screenshot capture, responsive breakpoint testing, dialog opening, "AI Integration" settings page, localhost-only security model |
