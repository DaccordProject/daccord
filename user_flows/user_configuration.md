...
| Video resolution presets are hardcoded | Low | Resolution options (480p, 720p, 1080p) and FPS options (15, 30, 60) are defined as literals rather than being data-driven or coming from AccordStream capabilities. |
