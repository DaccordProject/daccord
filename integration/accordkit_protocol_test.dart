...
Future<void> main() async {
  ...
  group('accordkit ↔ accordserver', () {
    ...
    group('membership changes mid-session', () {
      // Regression test for #218: the server snapshots a session's space
      // memberships at IDENTIFY and never refreshes them, so a space joined
      // while connected fans out nothing until the gateway reconnects. Unskip
      // when #218 is fixed.
      ...
      }, skip: 'blocked on #218 — memberships are snapshotted at IDENTIFY');
    });
