...
String? accordSpaceBannerUrl(AccordSpace space, String? cdnUrl, {bool versioned = true}) {
  ...
  return resolve(AccordCDN.spaceBanner(
    space.id,
    banner,
...
String? accordSpaceIconUrl(AccordSpace space, String? cdnUrl, {bool versioned = true}) {
  ...
  return resolve(AccordCDN.spaceIcon(
    space.id,
    icon,
